...
app.put("/users/update/", (req, res) => {
    ...
    if (!user) res.status(404).send(`user with the given ID was not found, ID: ${parseInt(id)}`);
    let respond = db.updateUser(req.body.id, req.body.changedUser);
